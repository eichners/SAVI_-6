...
function plotDataset(dataset) {
    SchooolSizeGeoJSON = L.geoJson(dataset, {
        style: mapStyle,
...
var schoolsPointToLayer = function (feature, latlng) {
    var schoolMarker = L.circle (latlng {

        stroke: 1,
        fillColor: fillColor(feature.properties.Growth/decline),
        fillOpacity: 0.7,
...
var schoolSize = feature.properties.Growth/decline; 


// var mapStyle = function (feature,latlng) {

//     var SizeChange = feature.properties.Growth/decline*10;
...
//         color: 'grey',
//         fillOpacity: .7,
//         fillColor: fillColor(SizeChange),
...
var mapStyle = function(feature, layer) {
    
    var circleColor = feature.properties.Growth/decline;
...
var mapOnEachFeature = function(feature,layer){
    var prettyGrowthDecline = (feature.properties.Growth/decline); // to fixed one keeps decimal to one place after.
    ...
    layer.on("click", function (e) {
        ...
        var popupContent = "<h4>"+ feature.properties.Growth/decline +"</h4><br /><strong>Total Population:</strong> " 
        + prettyGrowthDecline + "%";
        // see bottom of page for function above: function numberWithCommas(x) 
        // { etc.... this returns a string so it cannot be used again! maybe that's why it's last
